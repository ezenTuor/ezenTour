...
<div class="content_block" id="content">
	        ...
	        <input type="hidden" name="goodsCd" value="AVP8030">
	        ...
	        <input type="hidden" name="dspSid" value="AABM002">
	        ...
	        <input type="hidden" name="promotionNo" value="">
 	        ...
 	        <input type="hidden" name="nonCustYn" value="N">
				...
				<div class="step_box box_agree" id="term_con1" title="특별약관">
	                        	...
	                        	<div class="txt_agree" id="box_agree_internet">
	                        		<div class="wrap_agree">
	                       		 		<p><span style="color:rgb(0, 0, 0)">■ 특별약관<br>
&nbsp;본 상품의 예약과 취소는 </span><span style="color:rgb(255, 0, 0)"><strong>[국외여행 특별약관]</strong></span><span style="color:rgb(0, 0, 0)">이 적용됩니다.<br>
상기 상품은 국외여행표준약관(소비자분쟁해결기준)과 달리 특별약관이 적용되어 별도로 아래와 같은 취소수수료 특약이 적용되며, 별도의 동의 절차를 거치게 됩니다.</span></p>

<p><br>
<span style="color:rgb(0, 0, 0)">■ 기간에 따른 취소 환불 규정<br>
<strong>- 여행개시 30일 전까지 취소 통보 시 : 위약금 없음<br>
- 여행개시 29일 - 21일 전까지 취소 통보 시 : 여행요금 중 80% 배상<br>
- 여행개시 20일 - 17일 전까지 취소 통보 시 : 여행요금 중 90% 배상</strong><br>
<strong>- 여행개시 16일 -&nbsp; 여행출발 당일 까지 : 여행요금 중 100% 배상</strong><br>
<span style="color:rgb(0, 0, 0)">&nbsp;단, 출발일과 상관없이 사전 선발권 개별공지 후 발권된 예약건 및 호텔 확정된 예약건에 한하여 </span><span style="color:rgb(255, 0, 0)"><strong>"여행요금 중 100% 배상"</strong> </span><span style="color:rgb(0, 0, 0)">과 동일한 특별약관 환불규정이 적용됩니다.</span></span></p>

<p>&nbsp;</p>

<p><span style="color:rgb(0, 0, 0)">■&nbsp;취소 접수는 업무시간 내에 유선접수만 가능합니다.<br>
&nbsp; - 업무시간 : 월-금 9:00~18:00, 토/일요일 및 국가 공휴일 제외<br>
&nbsp; - 위약금 발생 시점이 주말/공휴일인 경우, 그 전 업무시간까지 취소 처리가 완료되어야 위약금이 발생하지 않습니다.</span></p>

<p>&nbsp;</p>

<p><span style="color:rgb(0, 0, 0)">■&nbsp;여행 참자가 수의 미달로 여행개시 7일전까지 여행계약 해제 통지시 : 전액환급<br>
■&nbsp;여행참가자 수의 미달로 인한 여행 개시 7일전까지 통지기일 미준수<br>
&nbsp;1) 여행개시 1일전까지 통지시 : 여행요금의 30% 배상<br>
&nbsp;2) 여행출발 당일 통지시 : 여행요금의 50% 배상</span></p>

<p><span style="color:rgb(0, 0, 0)">■&nbsp;여행 출발 이후 소비자와 사업자의 귀책사유 없이 당초 계획과 달리 이행되지 않은 일정이 있는 경우 : 이행되지 않은 일정 해당금액 환급 (단, 사업자가 이미 비용을 지급하고 환급받지 못하였음을 소비자에게 입증하는 경우와 별도의 비용 지출이 없음을 입증하는 경우는 제외함.)<br>
■&nbsp;여행 출발 이후 당초 계획과 다른 일정으로 대체 시 당초 일정의 소요 비용보다 대체 일정의 소요 비용이 적게 든 경우만 차액 환급</span></p>
	...
	<p>동의를 거부하시는 경우에도 예약 서비스를 이용하실 수 있습니다.</p>
			...
			<tr>
				...
				<td colspan="5">[푸꾸옥][VJ]빈펄리조트 X 실버 [전일정호텔조식_빈펄테마파크무제한]4일
			...
			<tr>
				<th scope="row"><label>예약 유형</label></th>
                    		...
                    		<td><span>대기자 예약 </span>[<span>0명</span><span> 대기자 예약중]</span></td>
				...
				<td>
							...
							<span class="air_ico"><img src="https://static.ybtour.com/images/air/VJ.png" alt="비엣젯항공"></span>
						
					
					<span class="air_txt">비엣젯항공</span>
				</td>
			</tr>			
			
			<tr>
				<th scope="row"><label>출발일</label></th>
				<td colspan="5">(한국 출발) 2020년 02월 07일(금) 01:45 (현지 도착) 2020년 02월 07일(금) 05:10<span class="flight_num_txt">VJ975</span></td>
			</tr>
			<tr>
				<th scope="row"><label>도착일</label></th>
				<td colspan="5">(현지 출발) 2020년 02월 10일(월) 15:20 (한국 도착) 2020년 02월 10일(월) 22:45<span class="flight_num_txt">VJ974</span></td>
			</tr>
			</tbody>
			</table>
			<!-- //상품 정보 요약 -->
			...
			<ul class="tbl_info_list">
				...
				<li>여행 도착일 7일 이후 자동 적립되며, 비회원의 경우 적립 기준일 이전에 회원 가입하여 별도 적립해야 합니다. (적립 기준일 이후에는 적립되지 않습니다.)</li>
		...
		<!-- //노랑풍선 마일리지 -->
				...
				<td colspan="5">
					<div class="tbl_line">
						...
						<div class="select normal yb_select" style="width: 150px">
							<select title="이메일 도메인 선택" name="selectemail" id="selectemail" style="">
						...
						<div class="selectIn" style="width: 56px;"><button type="button" class="currSel">직접입력</button><ul class="list"><li><button type="button" value="">직접입력</button></li><li><button type="button" value="naver.com">네이버</button></li><li><button type="button" value="hanmail.net">한메일</button></li><li><button type="button" value="nate.com">네이트</button></li><li><button type="button" value="daum.net">다음</button></li><li><button type="button" value="gmail.com">구글</button></li><li><button type="button" value="hotmail.com">핫메일</button></li><li><button type="button" value="yahoo.com">야후</button></li></ul></div></div>
					</div>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					...
					<div class="selectIn" style="width: 31px;"><button type="button" class="currSel">1명</button><ul class="list"><li><button type="button" value="1">1명</button></li><li><button type="button" value="2">2명</button></li><li><button type="button" value="3">3명</button></li><li><button type="button" value="4">4명</button></li><li><button type="button" value="5">5명</button></li><li><button type="button" value="6">6명</button></li><li><button type="button" value="7">7명</button></li><li><button type="button" value="8">8명</button></li><li><button type="button" value="9">9명</button></li><li><button type="button" value="10">10명</button></li><li><button type="button" value="11">11명</button></li><li><button type="button" value="12">12명</button></li><li><button type="button" value="13">13명</button></li><li><button type="button" value="14">14명</button></li><li><button type="button" value="15">15명</button></li><li><button type="button" value="16">16명</button></li><li><button type="button" value="17">17명</button></li><li><button type="button" value="18">18명</button></li><li><button type="button" value="19">19명</button></li><li><button type="button" value="20">20명</button></li><li><button type="button" value="21">21명</button></li><li><button type="button" value="22">22명</button></li><li><button type="button" value="23">23명</button></li><li><button type="button" value="24">24명</button></li><li><button type="button" value="25">25명</button></li><li><button type="button" value="26">26명</button></li><li><button type="button" value="27">27명</button></li><li><button type="button" value="28">28명</button></li><li><button type="button" value="29">29명</button></li><li><button type="button" value="30">30명</button></li></ul></div></div>
				</td>
				...
				<td>
					...
					<div class="selectIn" style="width: 31px;"><button type="button" class="currSel">0명</button><ul class="list"><li><button type="button" value="0">0명</button></li><li><button type="button" value="1">1명</button></li><li><button type="button" value="2">2명</button></li><li><button type="button" value="3">3명</button></li><li><button type="button" value="4">4명</button></li><li><button type="button" value="5">5명</button></li><li><button type="button" value="6">6명</button></li><li><button type="button" value="7">7명</button></li><li><button type="button" value="8">8명</button></li><li><button type="button" value="9">9명</button></li><li><button type="button" value="10">10명</button></li><li><button type="button" value="11">11명</button></li><li><button type="button" value="12">12명</button></li><li><button type="button" value="13">13명</button></li><li><button type="button" value="14">14명</button></li><li><button type="button" value="15">15명</button></li><li><button type="button" value="16">16명</button></li><li><button type="button" value="17">17명</button></li><li><button type="button" value="18">18명</button></li><li><button type="button" value="19">19명</button></li><li><button type="button" value="20">20명</button></li><li><button type="button" value="21">21명</button></li><li><button type="button" value="22">22명</button></li><li><button type="button" value="23">23명</button></li><li><button type="button" value="24">24명</button></li><li><button type="button" value="25">25명</button></li><li><button type="button" value="26">26명</button></li><li><button type="button" value="27">27명</button></li><li><button type="button" value="28">28명</button></li><li><button type="button" value="29">29명</button></li><li><button type="button" value="30">30명</button></li></ul></div></div>
				</td>
			...
			<tr id="adtTourList">
				...
				<td class="name_check">
					<div class="tbl_line">
						<div class="name_type">
							<span class="ico_tbl_must" title="필수입력"></span> 이름(한글) <input type="text" name="resNmKor" id="resNmKor1" title="한글이름 입력" placeholder="홍길동">
						</div>
						<div class="name_type">(영문)
							<input type="text" title="영문 성 입력" name="resNmLastEng" id="resNmLastEng1" placeholder="Hong" onkeyup="fnPressEng(event,this);">
							<input type="text" title="영문 이름 입력" name="resNmFirstEng" id="resNmFirstEng1" placeholder="Gil-dong" onkeyup="fnPressEng(event,this);">
						</div>
					</div>
				</td>
				...
				<td>
					<div class="tbl_line">
						<input type="number" name="tourlistHphone" placeholder="'-' 제외 숫자만 입력" readonly="" id="tourlistHphone1">
					</div>
				</td>
			</tr>
			</tbody>
					...
					<dd class="total_info">
						<ul class="psg_list">
							<li>
								...
								<p class="psg_price" id="adt_tot"><span class="price_txt">899,000</span><span>X&nbsp;&nbsp;1명</span></p>
							</li>
							<li>
								<p class="psg_type">아동</p>
								<p class="psg_price" id="chd_tot"><span class="price_txt">749,000</span><span>X&nbsp;&nbsp;0명</span></p>
							</li>
							<li>
								<p class="psg_type">유아</p>
								<p class="psg_price" id="inf_tot"><span class="price_txt">150,000</span><span>X&nbsp;&nbsp;0명</span></p>
							</li>
						</ul>
					</dd>
					<dd class="total_price emp_red" id="total_summary"><strong>899,000</strong> 원</dd>
				</dl>
				<div class="noti_info">
